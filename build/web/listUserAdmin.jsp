                    ...
                    <div class="rental-card">
                        ...
                        <table border="2" cellspacing="0px" height="80px;" border-radius="20px 20px 0px 0px;">
                            ...
                            <tr height="35px;">
                                ...
                                <td><%=x.getStatus()%></td>
                                <% } %>
                                <td><a href="EditStatus?username=<%=x.getUsername()%>&page=before">Edit Status</a> | <a href="checkDeleteUser?username=<%=x.getUsername()%>">Delete</a></td>
                            </tr>
                            <%}%>
                        </table>
                        <% } else { %>
